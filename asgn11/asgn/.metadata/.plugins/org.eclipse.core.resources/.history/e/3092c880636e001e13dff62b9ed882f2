...
public class HashsetTesting {
	...
	public static void main(String[] args) {
		HashSet<BookShop> booklist = new LinkedHashSet<BookShop>();
		...
		/*
		 * LinkedHashSet is allowing duplicate value, it is not giving any error, exception
		 * and adding the duplicate values because equals() is present and hashcode() is not
		 * present in the class .. after hashCode() and equals() both are present no duplicate values are
